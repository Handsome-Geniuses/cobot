package com.handsome.nosnhoj.impl.Hello.HelloToolbar;
...
public class HelloToolbarService implements SwingToolbarService{
	...
	public SwingToolbarContribution createToolbar(ToolbarContext context) {
		return new HelloToolbarContribution(context);
	}
